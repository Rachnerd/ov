    ...
    const tpl = html`
      <div style="display:flex;flex-direction:column;gap:12px;max-width:400px">
        ...
        <ov-toast
          ...
          variant="warning"
          title="Storage low"
          message="Less than 100 MB remaining."
          duration="0"
        ></ov-toast>
      </div>
    `;
  ...
  render: () => {
    const tpl = html`
      <div style="position:relative;height:200px;max-width:400px">
        <div
          style="position:absolute;bottom:0;right:0;display:flex;flex-direction:column;gap:8px;width:100%"
        >
          <ov-toast
            id="stack-1"
            variant="success"
            title="File uploaded"
            message="report-q1.pdf was uploaded successfully."
            duration="0"
          ></ov-toast>
          <ov-toast
            id="stack-2"
            variant="info"
            title="Sync complete"
            message="Your portfolio was synced with the latest market data."
            duration="0"
          ></ov-toast>
        </div>
      </div>
