...
const meta: Meta = {
  ...
  argTypes: {
    variant: {
      control: 'select',
      options: ['default', 'brand', 'inverse', 'inverse-brand'],
    },
    ...
    <div style="max-width:360px">
      ...
      >
        ...
        <ov-text variant="body-sm" as="p">
          Track your investments, monitor performance, and stay informed about
          market movements.
        </ov-text>
        <div slot="footer">
...
export const AllVariants: Story = {
  render: () => html`
    <div
      style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;max-width:720px"
    >
      <ov-card variant="default">
        <div slot="header"><ov-heading level="4">Default</ov-heading></div>
        <ov-text variant="body-sm" as="p"
          >White surface, charcoal text. The standard workhorse.</ov-text
        >
      </ov-card>
      <ov-card variant="brand">
        <div slot="header"><ov-heading level="4">Brand</ov-heading></div>
        <ov-text variant="body-sm" as="p"
          >Blue background for featured content and CTAs.</ov-text
        >
      </ov-card>
      <ov-card variant="inverse">
        <div slot="header"><ov-heading level="4">Inverse</ov-heading></div>
        <ov-text variant="body-sm" as="p"
          >Charcoal surface for dark sections and sidebars.</ov-text
        >
      </ov-card>
      <ov-card variant="inverse-brand">
        <div slot="header">
          <ov-heading level="4">Inverse Brand</ov-heading>
        </div>
        <ov-text variant="body-sm" as="p"
          >Brand blue text on charcoal — high contrast accent.</ov-text
        >
      </ov-card>
    </div>
  `,
...
export const InteractiveCards: Story = {
  render: () => html`
    <div
      style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;max-width:720px"
    >
      <ov-card interactive>
        <div slot="header">
        ...
        <ov-text variant="body-sm" tone="secondary" as="p"
          >$148,320 · 32% of portfolio</ov-text
        >
      </ov-card>
      <ov-card interactive>
        <div slot="header">
        ...
        <ov-text variant="body-sm" tone="secondary" as="p"
          >$87,500 · 19% of portfolio</ov-text
        >
      </ov-card>
      <ov-card interactive>
        <div slot="header">
...
export const StatCard: Story = {
  ...
  render: () => html`
    <div
      style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;max-width:640px"
    >
      <ov-card>
        <ov-text variant="eyebrow" as="p">Total value</ov-text>
        <ov-heading level="2" size="display-2" style="margin-top:4px"
          >$463,218</ov-heading
        >
        <ov-text variant="body-sm" tone="success" as="p" style="margin-top:4px"
          >↑ 14.3% this quarter</ov-text
        >
      </ov-card>
      <ov-card>
      ...
      <ov-card variant="brand">
        ...
        <ov-heading level="2" size="display-2" style="margin-top:4px"
          >6 / 10</ov-heading
        >
        <ov-text variant="body-sm" as="p" style="margin-top:4px"
          >Moderate growth</ov-text
        >
      </ov-card>
    </div>
  `,
      ...
      <ov-card>
        <div slot="header" style="display:flex;align-items:center;gap:12px">
          ...
          <div>
            ...
            <ov-text variant="body-sm" tone="secondary"
              >Senior Portfolio Manager</ov-text
            >
          </div>
        </div>
        <ov-text variant="body-sm" as="p" tone="secondary">
          Specializing in ESG and emerging market equities with 12 years of
          experience.
        </ov-text>
        <div slot="footer">
