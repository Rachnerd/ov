  ...
  render: () => html`
    <div style="max-width:560px;display:flex;flex-direction:column;gap:12px">
      <ov-alert variant="info" title="Portfolio rebalanced">
        Your portfolio was automatically rebalanced to match your target
        allocation.
      </ov-alert>
      ...
      <ov-alert variant="warning" title="Margin call approaching">
        Your margin usage is at 78%. Consider reducing exposure to avoid a
        margin call.
      </ov-alert>
  ...
  render: () => html`
    <div style="max-width:560px;display:flex;flex-direction:column;gap:12px">
      <ov-alert variant="info" title="New feature available" dismissible>
        We've launched AI-powered insights for your portfolio. Try it now in the
        Reports tab.
      </ov-alert>
  ...
  render: () => html`
    <div style="max-width:560px;display:flex;flex-direction:column;gap:12px">
      ...
      <ov-alert variant="info" title="Upgrade your plan">
        You've used 80% of your report quota. Upgrade to Pro for unlimited
        reports.
        <div slot="actions">
  ...
  render: () => html`
    <div style="max-width:560px;display:flex;flex-direction:column;gap:12px">
      ...
      <ov-alert variant="danger"
        >Unable to connect to the data provider. Please try again.</ov-alert
      >
    </div>
  `,
};
