...
export class OvHeading extends LitElement {
  ...
  static override styles = [
    ...
    css`
      ...
      :host([size='h1']) :is(h1,h2,h3,h4,h5,h6) { font-weight: var(--ov-fw-semibold); font-size: var(--ov-fs-xl); }
      :host([size='h2']) :is(h1,h2,h3,h4,h5,h6) { font-weight: var(--ov-fw-semibold); font-size: var(--ov-fs-lg); }
      :host([size='h3']) :is(h1,h2,h3,h4,h5,h6) { font-weight: var(--ov-fw-medium);   font-size: var(--ov-fs-md); }
      :host([size='h4']) :is(h1,h2,h3,h4,h5,h6) { font-weight: var(--ov-fw-medium);   font-size: var(--ov-fs-base); }
      ...
      :host(:not([size])) h1 { font-weight: var(--ov-fw-semibold); font-size: var(--ov-fs-xl); }
      :host(:not([size])) h2 { font-weight: var(--ov-fw-semibold); font-size: var(--ov-fs-lg); }
      :host(:not([size])) h3 { font-weight: var(--ov-fw-medium);   font-size: var(--ov-fs-md); }
      :host(:not([size])) h4 { font-weight: var(--ov-fw-medium);   font-size: var(--ov-fs-base); }
      :host(:not([size])) h5 { font-weight: var(--ov-fw-medium);   font-size: var(--ov-fs-sm); }
      :host(:not([size])) h6 {
