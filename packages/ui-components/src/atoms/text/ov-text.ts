...
export class OvText extends LitElement {
  ...
  static override styles = [
    ...
    css`
      ...
      :host([variant='body-sm']) .t {
        font-size: var(--ov-fs-sm);
        line-height: var(--ov-lh-normal);
      }
      :host([variant='caption']) .t {
        font-size: var(--ov-fs-xs);
        line-height: var(--ov-lh-normal);
        color: var(--_tone, var(--color-text-tertiary));
      }
      :host([variant='lead']) .t {
      ...
      :host([tone='tertiary']) {
        --_tone: var(--color-text-tertiary);
      }
      :host([tone='muted']) {
        --_tone: var(--color-text-muted);
      }
      :host([tone='brand']) {
      ...
      /* Weight */
      :host([weight='light']) {
        --_weight: var(--ov-fw-light);
      }
      :host([weight='regular']) {
        --_weight: var(--ov-fw-regular);
      }
      :host([weight='medium']) {
        --_weight: var(--ov-fw-medium);
      }
      :host([weight='semibold']) {
        --_weight: var(--ov-fw-semibold);
      }
      :host([weight='bold']) {
        --_weight: var(--ov-fw-bold);
      }
    `,
  ];
  ...
  protected override render(): TemplateResult | typeof nothing {
    switch (this.as) {
      case 'p':
        return html`<p class="t"><slot></slot></p>`;
      case 'div':
        return html`<div class="t"><slot></slot></div>`;
      case 'small':
        return html`<small class="t"><slot></slot></small>`;
      case 'strong':
        return html`<strong class="t"><slot></slot></strong>`;
      case 'em':
        return html`<em class="t"><slot></slot></em>`;
      case 'span':
