...
export const SettingsPanel: Story = {
  ...
  render: () => html`
    <div
      style="display:flex;flex-direction:column;gap:0;max-width:360px;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden"
    >
      ${[
        ...
        (item, i, arr) => html`
          <div
            style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;${i <
            arr.length - 1
