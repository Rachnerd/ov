...
export class OvBadge extends LitElement {
  ...
  @property({ type: String, reflect: true }) appearance: BadgeAppearance =
    'soft';
  ...
  static override styles = [
    ...
    css`
      ...
      /* Soft (default) */
      :host([variant='brand']) .b {
        --_bg: var(--color-brand-subtle);
        --_fg: var(--color-text-link);
      }
      :host([variant='accent']) .b {
        --_bg: var(--color-accent-subtle);
        --_fg: var(--color-accent);
      }
      :host([variant='success']) .b {
        --_bg: var(--color-success-bg);
        --_fg: var(--color-success-text);
      }
      :host([variant='warning']) .b {
        --_bg: var(--color-warning-bg);
        --_fg: var(--color-warning-text);
      }
      :host([variant='danger']) .b {
      ...
      /* Solid */
      :host([appearance='solid'][variant='brand']) .b {
        --_bg: var(--color-brand);
        --_fg: var(--color-text-on-brand);
      }
      :host([appearance='solid'][variant='accent']) .b {
        --_bg: var(--color-accent);
        --_fg: var(--color-accent-contrast);
      }
      :host([appearance='solid'][variant='success']) .b {
        --_bg: var(--color-success);
        --_fg: var(--ov-white);
      }
      :host([appearance='solid'][variant='warning']) .b {
        --_bg: var(--color-warning);
        --_fg: var(--ov-neutral-900);
      }
      :host([appearance='solid'][variant='danger']) .b {
        --_bg: var(--color-danger);
        --_fg: var(--ov-white);
      }
      :host([appearance='solid'][variant='info']) .b {
        --_bg: var(--color-info);
        --_fg: var(--ov-white);
      }
      :host([appearance='solid'][variant='default']) .b {
        --_bg: var(--color-text-primary);
        --_fg: var(--color-bg-surface);
      }

      /* Outline */
      :host([appearance='outline']) .b {
        --_bg: transparent;
        --_border: var(--color-border-default);
      }
      :host([appearance='outline'][variant='brand']) .b {
        --_fg: var(--color-brand);
        --_border: var(--color-brand);
      }
      :host([appearance='outline'][variant='accent']) .b {
        --_fg: var(--color-accent);
        --_border: var(--color-accent);
      }
      :host([appearance='outline'][variant='success']) .b {
        --_fg: var(--color-success);
        --_border: var(--color-success);
      }
      :host([appearance='outline'][variant='warning']) .b {
        --_fg: var(--color-warning);
        --_border: var(--color-warning);
      }
      :host([appearance='outline'][variant='danger']) .b {
        --_fg: var(--color-danger);
        --_border: var(--color-danger);
      }
      :host([appearance='outline'][variant='info']) .b {
        --_fg: var(--color-info);
        --_border: var(--color-info);
      }
