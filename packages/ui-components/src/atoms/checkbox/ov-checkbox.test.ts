...
describe('ov-checkbox', () => {
  ...
  describe('rendering', () => {
    it('renders a hidden native checkbox input', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox>Accept</ov-checkbox>`,
      );
    ...
    it('projects label text through the default slot', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox>Accept terms</ov-checkbox>`,
      );
  ...
  describe('properties and attributes', () => {
    ...
    it('reflects checked attribute when set initially', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox checked>Accept</ov-checkbox>`,
      );
    ...
    it('reflects disabled attribute', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox disabled>Accept</ov-checkbox>`,
      );
    ...
    it('updates native indeterminate from property', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox>Select all</ov-checkbox>`,
      );
      el.indeterminate = true;
      await elementUpdated(el);
      expect(
        el.shadowRoot!.querySelector<HTMLInputElement>('input')!.indeterminate,
      ).to.be.true;
    });
  ...
  describe('events', () => {
    it('dispatches "change" event with checked=true when checked', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox value="accepted">Accept</ov-checkbox>`,
      );
    ...
    it('dispatches "change" event with checked=false when unchecked', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox checked value="on">Accept</ov-checkbox>`,
      );
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
    ...
    it('clears indeterminate state on change', async () => {
      const el = await fixture<OvCheckbox>(
        html`<ov-checkbox indeterminate>Select all</ov-checkbox>`,
      );
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
  ...
  describe('accessibility', () => {
    it('passes axe with label text', async () => {
      const el = await fixture(
        html`<ov-checkbox>Receive newsletters</ov-checkbox>`,
      );
    ...
    it('passes axe when disabled', async () => {
      const el = await fixture(
        html`<ov-checkbox disabled>Disabled option</ov-checkbox>`,
      );
      await expect(el).to.be.accessible({
        ignoredRules: ['color-contrast'],
      });
