...
import '@ov/ui-components/atoms/switch/ov-switch';
...
export class OvSwitchComponent implements OnChanges, OnInit, OnDestroy {
  @Input() checked = false;
  ...
  ngOnChanges(): void {
    applyProps(this._el, { checked: this.checked });
  }
